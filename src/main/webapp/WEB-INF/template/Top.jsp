			...
			<div class="left-side">
				...
				<div id="logo">
					<a href="<c:url value='/'/>"><img
						...
						data-sticky-logo="<c:url value='/resources/images/logo.png'/>"
						alt=""></a>
				</div>
				...
				<nav id="navigation" class="style-1">
					<ul id="responsive">
						<li><a class="current" href="#">임시메인모음</a>
							<ul>
								<li><a
									href="<c:url value = '/EveryShare/TempMain/TempMain.bbs'/>">메인화면</a></li>
								<li><a
									href="<c:url value = '/EveryShare/TempMain/TempSubMain.bbs'/>">사이드바메인</a></li>
							</ul></li>
						...
						<li><a href="#">서비스</a>
							<ul>
								<li><a href="#">쉐어링</a>
									<ul>
										<li><a
											href="<c:url value = '/EveryShare/Service/SharingView.bbs'/>">상세보기</a></li>
										<li><a
											href="<c:url value = '/EveryShare/Service/SharingWrite.bbs'/>">등록</a></li>
									</ul></li>
								<li><a href="#">공동구매</a>
									<ul>
										<li><a
											href="<c:url value = '/EveryShare/Service/GroupBuyView.bbs'/>">상세보기</a></li>
										<li><a
											href="<c:url value = '/EveryShare/Service/GroupBuyWrite.bbs'/>">등록</a></li>
										<li><a
											href="<c:url value = '/EveryShare/Service/GroupBuyPayment.bbs'/>">결제</a></li>
									</ul></li>
							</ul></li>
						<li><a
							href="<c:url value = '/EveryShare/Service/CustomerCenter.bbs'/>">고객센터</a></li>
						<li><a href="#">마이페이지</a>
							<ul>
								<li><a
									href="<c:url value = '/EveryShare/Service/MyActivity.bbs'/>">활동내역</a></li>
								<li><a
									href="<c:url value = '/EveryShare/Service/MyPoint.bbs'/>">포인트조회</a></li>
			...
			<div class="right-side">
				<div class="header-widget">
					<a href="#sign-in-dialog" class="sign-in popup-with-zoom-anim"><i
						...
						href="dashboard-add-listing.html" class="button border with-icon">Add
						Listing <i class="sl sl-icon-plus"></i>
					</a>
				</div>
			</div>
					...
					<div class="tabs-container alt">
						...
						<div class="tab-content" id="tab2" style="display: none;">
							...
							<form method="post" class="register">
								...
								<p class="form-row form-row-wide">
									<label for="email2">Email: <i class="im im-icon-Mail"></i>
								...
								<p class="form-row form-row-wide">
									<label for="username2">이름: <i class="im im-icon-Male"></i>
								...
								<p class="form-row form-row-wide">
									...
									<label for="inputPhoneNumber">Tel: <i
										class="im-icon-Old-Telephone"></i> <input type="tel"
